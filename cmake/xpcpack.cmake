...
set(CPACK_PACKAGE_CONTACT "(435)713-3446)")
...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "${CPACK_PACKAGE_NAME} Revision ${revNum}")
set(CPACK_PACKAGE_VERSION ${CMAKE_PROJECT_VERSION})
set(CPACK_PACKAGE_VERSION_MAJOR ${CMAKE_PROJECT_VERSION_MAJOR})
set(CPACK_PACKAGE_VERSION_MINOR ${CMAKE_PROJECT_VERSION_MINOR})
set(CPACK_PACKAGE_VERSION_PATCH ${CMAKE_PROJECT_VERSION_PATCH})
set(CPACK_PACKAGE_VERSION_TWEAK ${CMAKE_PROJECT_VERSION_TWEAK})
set(CPACK_PACKAGE_HOMEPAGE_URL https://www.sdl.usu.edu/)
...
set(CPACK_COMPONENT_CLIENT_DISPLAY_NAME "${CPACK_PACKAGE_NAME} client")
set(CPACK_COMPONENT_CLIENT_DESCRIPTION "${CPACK_COMPONENT_CLIENT_DISPLAY_NAME}")
set(CPACK_COMPONENT_SERVER_DISPLAY_NAME "${CPACK_PACKAGE_NAME} server")
set(CPACK_COMPONENT_SERVER_DESCRIPTION "${CPACK_COMPONENT_SERVER_DISPLAY_NAME}")
set(CPACK_COMPONENT_TEST_DISPLAY_NAME "${CPACK_PACKAGE_NAME} test")
set(CPACK_COMPONENT_TEST_DESCRIPTION "${CPACK_COMPONENT_TEST_DISPLAY_NAME}")
set(CPACK_COMPONENT_TOOL_DISPLAY_NAME "${CPACK_PACKAGE_NAME} tool")
set(CPACK_COMPONENT_TOOL_DESCRIPTION "${CPACK_COMPONENT_TOOL_DISPLAY_NAME}")
set(CPACK_ARCHIVE_COMPONENT_INSTALL ON)
if(WIN32)
  set(CPACK_GENERATOR ZIP WIX)
  if(NOT DEFINED CPACK_COMPONENTS_ALL)
    list(REMOVE_ITEM CPACK_GENERATOR WIX)
  elseif(CPACK_COMPONENTS_ALL STREQUAL tool)
    list(REMOVE_ITEM CPACK_GENERATOR WIX)
  endif()
  if(CPACK_GENERATOR MATCHES WIX)
    if(NOT DEFINED CPACK_WIX_PRODUCT_ICON)
      set(CPACK_WIX_PRODUCT_ICON ${CMAKE_CURRENT_LIST_DIR}/Vantage.ico)
    endif()
    if(NOT DEFINED CPACK_WIX_UI_BANNER)
      set(CPACK_WIX_UI_BANNER ${CMAKE_CURRENT_LIST_DIR}/VantageBannerWix.bmp)
    endif()
    if(NOT DEFINED CPACK_WIX_UI_DIALOG)
      set(CPACK_WIX_UI_DIALOG ${CMAKE_CURRENT_LIST_DIR}/VantageDialogWix.bmp)
    endif()
...
elseif(CMAKE_SYSTEM_NAME STREQUAL Linux)
  ...
  if(NOT DEFINED CPACK_COMPONENTS_ALL)
    list(REMOVE_ITEM CPACK_GENERATOR RPM)
  elseif(CPACK_COMPONENTS_ALL STREQUAL tool)
    list(REMOVE_ITEM CPACK_GENERATOR RPM)
  endif()
  if(CPACK_GENERATOR MATCHES RPM)
    set(CPACK_RPM_COMPONENT_INSTALL ON)
    set(CPACK_RPM_PACKAGE_LICENSE "see software manual")
    set(CPACK_RPM_PACKAGE_RELOCATABLE FALSE)
    if(NOT DEFINED XP_RPM_OWNER)
      set(XP_RPM_OWNER vantage)
    endif()
    ...
    configure_file(${CMAKE_CURRENT_LIST_DIR}/scripts.postinstall.client.in cpack.scripts/postinstall.client @ONLY)
    configure_file(${CMAKE_CURRENT_LIST_DIR}/scripts.preinstall.in cpack.scripts/preinstall @ONLY)
    configure_file(${CMAKE_CURRENT_LIST_DIR}/scripts.postinstall.in cpack.scripts/postinstall @ONLY)
    configure_file(${CMAKE_CURRENT_LIST_DIR}/scripts.preremove.in cpack.scripts/preremove @ONLY)
    configure_file(${CMAKE_CURRENT_LIST_DIR}/scripts.service.in cpack.scripts/${XP_RPM_UNIT_FILE} @ONLY)
...
configure_file(${CMAKE_CURRENT_LIST_DIR}/scripts.cpackcond.in cpack.scripts/cpackcond.cmake @ONLY)
