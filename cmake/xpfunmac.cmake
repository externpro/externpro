...
function(ipExternPackageExtractLinkItemNames _out items project_targets)
  set(_names)
...
function(ipExternPackageInferDeps _out_deps _out_pvt_deps)
  ...
  endforeach()
  ipExternPackageExtractLinkItemNames(_pub_names "${_all_iface}" "${P_TARGETS}")
  ipExternPackageExtractLinkItemNames(_pvt_names "${_all_link}" "${P_TARGETS}")
  if(_pvt_names AND _pub_names)
    list(REMOVE_ITEM _pvt_names ${_pub_names})
  endif()
  set(${_out_deps} "${_pub_names}" PARENT_SCOPE)
