...
function(ipDownload url sha dst)
  ...
  foreach(attempt RANGE 0 ${max_retries})
    ...
    if(msg MATCHES ".*[Hh][Aa][Ss][Hh][ ]mismatch.*" OR log MATCHES ".*[Hh][Aa][Ss][Hh][ ]mismatch.*")
      message(FATAL_ERROR "ipDownload: hash mismatch downloading ${url} (${code}): ${msg}\n${log}")
    endif()
    ...
    foreach(dep ${P_DEPS})
      if(DEFINED xp_${dep} AND DEFINED xp_${dep}_${P_PKG})
        ...
        if(NOT "${_pinned_key}" STREQUAL "${_parent_key}")
          ...
          string(APPEND depsMismatchReport "- ${P_PKG} -> ${dep}\n")
          string(APPEND depsMismatchReport "  pinned:   TAG=${PIN_TAG}  SHA=${_pin_sha}  REPO=${PIN_REPO}\n")
          string(APPEND depsMismatchReport "  manifest: TAG=${PAR_TAG}  SHA=${_par_sha}  REPO=${PAR_REPO}\n")
        endif()
      endif()
    endforeach()
  endblock()
