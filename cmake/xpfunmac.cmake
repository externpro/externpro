...
function(ipGetPrefixPath pfx pth)
  ...
  set(oneValueArgs PKG DIST_DIR REPO TAG SHA256_${CPACK_SYSTEM_NAME} URL_${CPACK_SYSTEM_NAME})
  ...
  elseif(DEFINED P_URL_${CPACK_SYSTEM_NAME} AND DEFINED P_SHA256_${CPACK_SYSTEM_NAME})
    set(url ${P_URL_${CPACK_SYSTEM_NAME}})
    set(sha ${P_SHA256_${CPACK_SYSTEM_NAME}})
  elseif(DEFINED P_PKG AND DEFINED P_REPO AND DEFINED P_TAG AND DEFINED P_SHA256_${CPACK_SYSTEM_NAME})
