...
function(ipGetPrefixPath pfx pth)
  ...
  elseif(DEFINED P_PKG AND DEFINED P_REPO AND DEFINED P_TAG AND DEFINED P_SHA256_${SYS_NAME})
    set(url https://${P_REPO}/releases/download/${P_TAG}/${P_PKG}-${P_TAG}-${SYS_NAME}-devel.tar.xz)
    set(sha ${P_SHA256_${SYS_NAME}})
