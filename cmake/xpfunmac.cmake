...
macro(xpSourceListAppend)
  ...
  if(NOT ${CMAKE_BINARY_DIR} STREQUAL ${CMAKE_CURRENT_BINARY_DIR})
    ...
    if(EXISTS ${CMAKE_SOURCE_DIR}/.git)
      ...
      xpGitIgnoredFiles(gitIgnoredFiles ${_dir})
      xpGitUntrackedFiles(gitUntrackedFiles ${_dir})
      file(GLOB_RECURSE gitFiles LIST_DIRECTORIES false .git/*)
      set(xpIgnoredGlobs)
      foreach(fileOrDir ${XP_SOURCE_DIR_IGNORE})
        if(IS_DIRECTORY ${fileOrDir})
          list(APPEND xpIgnoredGlobs "${fileOrDir}/*")
        else()
          list(APPEND xpIgnoredGlobs "${fileOrDir}")
        endif()
      endforeach()
      file(GLOB_RECURSE xpIgnoredFiles LIST_DIRECTORIES false ${xpIgnoredGlobs})
      set(filesAccountedFor ${gitFiles} ${gitUntrackedFiles} ${gitIgnoredFiles} ${masterSrcList} ${xpIgnoredFiles})
      file(GLOB_RECURSE repoFiles LIST_DIRECTORIES false *)
      list(REMOVE_ITEM repoFiles ${filesAccountedFor})
...
macro(xpPackageDevel)
  ...
  if(DEFINED ENV{XPX})
    set(CPACK_PACKAGE_FILE_NAME "${CMAKE_PROJECT_NAME}-${CPACK_PACKAGE_VERSION}-$ENV{XPX}")
  endif()
  include(CPack)
