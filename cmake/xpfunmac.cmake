...
function(ipGetPrefixPath pfx pth)
  ...
  elseif(DEFINED P_URL_${CPACK_SYSTEM_NAME} AND DEFINED P_MD5_${CPACK_SYSTEM_NAME})
    set(url ${P_URL_${CPACK_SYSTEM_NAME}})
    set(md5 ${P_MD5_${CPACK_SYSTEM_NAME}})
  elseif(DEFINED P_PKG AND DEFINED P_REPO AND DEFINED P_TAG AND DEFINED P_MD5_${CPACK_SYSTEM_NAME})
    set(url https://${P_REPO}/releases/download/${P_TAG}/${P_PKG}-${P_TAG}-${CPACK_SYSTEM_NAME}-devel.tar.xz)
    set(md5 ${P_MD5_${CPACK_SYSTEM_NAME}})
  ...
  if(DEFINED url AND DEFINED md5)
    ...
    FetchContent_Declare(${fcName} URL ${url} URL_HASH MD5=${md5} DOWNLOAD_NO_EXTRACT TRUE)
...
macro(xpPackageDevel)
  set(oneValueArgs PRJ_NAME EXE EXE_PATH TARGETS_FILE)
  ...
  include(CPack)
  if(NOT DEFINED P_PRJ_NAME)
    set(P_PRJ_NAME ${CMAKE_PROJECT_NAME})
  endif()
  string(TOUPPER ${P_PRJ_NAME} PRJ)
  string(TOLOWER ${P_PRJ_NAME} NAME)
  set(VER ${gitDescribe})
  if(DEFINED P_DEPS)
