...
function(xpFindPkg)
  ...
  foreach(package ${FP_PKGS})
    ...
    if(DEFINED xp_${pkg})
      ...
      if(EXISTS ${pth}/share/cmake/xpuse-${pkg}.cmake)
        unset(xpuse-${pkg}_DIR CACHE)
        find_package(xpuse-${pkg} BYPASS_PROVIDER REQUIRED PATHS ${pth}/share/cmake NO_DEFAULT_PATH)
        mark_as_advanced(xpuse-${pkg}_DIR)
      else()
        find_package(${pkg} REQUIRED CONFIG BYPASS_PROVIDER PATHS ${pth} ${pth}/share/cmake NO_DEFAULT_PATH)
        if(DEFINED ${pkg}_CONFIG AND ${pkg}_CONFIG MATCHES "\\.cps$")
          message(STATUS "Found ${pkg} (cps): ${${pkg}_VERSION}")
        endif()
      endif()
