...
function(ipGetPrefixPath pfx pth)
  ...
  cmake_parse_arguments(P "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})
  if(P_XP_MODULE)
    if(NOT EXISTS ${xpuse-exdlpro_DIR})
      xpFindPkg(PKGS exdlpro)
    elseif(NOT EXISTS ${XP_MODULE_PATH})
      set(XP_MODULE_PATH ${xpuse-exdlpro_DIR})
    endif()
    set(pfx usexp)
  ...
  elseif(DEFINED P_REPO AND DEFINED P_TAG AND DEFINED P_SHA256_${SYS_NAME})
    ...
    if(PKG_NAME STREQUAL "exdlpro")
      ...
      find_package(exdlpro BYPASS_PROVIDER)
...
function(xpFindPkg)
  ...
  foreach(package ${FP_PKGS})
    ...
    if(DEFINED xp_${pkg})
      ...
      find_package(${package} BYPASS_PROVIDER)
    endif()
