...
function(generateSyncScript)
  ...
  set(oneValueArgs ${reqArgs} BASE DESC DIST_DIR LICENSE UPSTREAM VER WEB SHA256_JetPack SHA256_Linux-arm64 URL_JetPack URL_Linux URL_Linux-arm64 URL_win64 SHA256_utres)
  ...
  if(DEFINED P_SHA256_JetPack)
    set(moreCowbell "${moreCowbell}\ndownloadAndCompare ${P_PKG}-${P_TAG}-JetPack-devel.tar.xz ${P_SHA256_JetPack}")
  endif()
  if(DEFINED P_SHA256_Linux-arm64)
    set(moreCowbell "${moreCowbell}\ndownloadAndCompare ${P_PKG}-${P_TAG}-Linux-arm64-devel.tar.xz ${P_SHA256_Linux-arm64}")
  endif()
